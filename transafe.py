...
with open(requiredDir + "\\"+'test2.csv','r') as csvfile:
        ...
        if rowcount > 9:
            ...
            if (row[1] == row[3]) and row[0] != "Grand Totals":
                ...
                if first_entry_flag:
                    ...
                    total_unexpected_journeysummary=0
                    total_assets += 1
                    num_of_events = 0
                    ...
                    if fault_flag:
                        ...
                        print("QC FAIL !! {} has {} odo jumps and {} unexpected order of events and {} unexpected journey sumaary".format(current_asset, total_odo_jumps, total_unexpected_order, total_unexpected_journeysummary))
                        print("----------------------------------------------------------------")
                    else:
                ...
                # now we check if the sequence of journey summary are in the expected order for journey summary
                if row[1] == "Power Up":
                    if previous_1_row[1] in ["Ignition On","Power Up","External Power Loss"] and previous_2_row[1] in ["External Power Loss","Ignition Off","Tag Out","Tag In","Journey Summary","Idle End","Heartbeat","Stop Moving","Power Up"]:
